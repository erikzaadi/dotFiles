...
map('n', '<leader>a', '<cmd>Telescope live_grep<cr>', 'Live grep (!)')
map('n', '<leader>K', '<cmd>Telescope grep_string<cr>', 'Grep word under cursor')
map('n', '<leader>e', '<cmd>Telescope file_browser<cr>', 'File finder')
...
map('n', '<leader><C-Tab>', ':tabnew<CR>', 'New', 'Tabs')
