...
-- Filetype overrides
 ...
 -- Javascript / Coffeescript / Node
    ...
    cmd 'au FileType javascript,coffee,typescript,typescriptreact,jsx,tsx,ts set softtabstop=2 tabstop=2 shiftwidth=2 noexpandtab'
...
-- Misc
    ...
    g.markdown_fenced_languages = {
        ...
        'ruby', 'xml', 'html', 'python', 'go', 'yaml', 'sh', 'bash=sh', 'zsh', 'groovy',
        'sql', 'terraform', 'hcl', 'lua', 'rust', 'toml', 'graphql',
    }
